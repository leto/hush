...
UniValue getwalletinfo(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee configuration, set in HUSH/KB\n"
            "}\n"
            "\nExamples:\n"
...
UniValue z_getbalance(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size()==0 || params.size() >2)
        throw runtime_error(
            ...
            "2. minconf          (numeric, optional, default=1) Only include transactions confirmed at least this many times.\n"
            "\nResult:\n"
            "amount              (numeric) The total amount in HUSH received for this address.\n"
            "\nExamples:\n"
...
UniValue z_sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "      \"amount\":amount    (numeric, required) The numeric amount in HUSH is the value\n"
